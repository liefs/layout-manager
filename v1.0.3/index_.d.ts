...
*/
declare function H(...Arguments: Array<any>): Handler;
/**
...
*/
declare function onEvent(el: any, eventType: string, eventFunction: Function): void;
/**
...
*/
declare function nthIndex(str: string, pat: string, n: number): number;
declare function htmlToElement(html: any): Node;
/**
...
*/
declare function occurrences(thisString: string, subString: string, allowOverlapping?: boolean): number;
declare function swapEl(source: any, replacement: any): void;
/**
...
*/
declare function trimCompare(a: string, b: string): boolean;
/**
...
*/
declare function isStart(value: string): boolean;
/**
...
* @param value number to be converted to string, then px added
*/
declare function vpx(value: string): number;
/**
...
*/
declare function TypeOf(value: any, match?: string): string | boolean;
/**
...
*/
declare function setArgsObj(key: string, index?: number, ref?: string): any;
/**
...
*/
declare function argsObj(args: IArguments): any;
declare function replaceAll(sstring: string, omit: string, place: string, prevstring?: string): string;
/**
...
*/
declare function CheckArgTypes(args: IArguments, types: string[], reference?: string, checkLength?: boolean): boolean;
/**
...
*/
declare function el(id: string): Element;
/**
...
*/
declare function isUniqueSelector(selector: string): boolean;
/**
...
*/
declare function directive(querrySelectorAll: string, attributesList: Array<string>): Array<{}>;
/**
...
*/
declare function directiveSetStyles(el: Element, stylesObject: {}): void;
/**
...
*/
declare function myIndexOf(sstring: string, search: string, occurance: number, start: number): string;
declare function screenSize(): {
    x: number;
    y: number;
};
declare let CFL: any[];
declare function mymouseleave(): void;
declare function context(el: HTMLElement, selectionList: Array<[string, Function]>, stylestring?: string): void;
/**
 ...
 */
declare let I: typeof Item.I;
/**
 * ##### ** var v = Item.I:**
 *
 * See [liefs-layout-manager.Item.I() ](https://liefs.github.io/classes/_liefs_layout_manager_.item.html)
 */
declare let v: typeof Item.v;
/**
 * ##### ** var h = Item.I:**
 *
 * See [liefs-layout-manager.Item.I() ](https://liefs.github.io/classes/_liefs_layout_manager_.item.html)
 */
declare let h: typeof Item.h;
/**
 * ##### ** var h = Item.I:**
 *
...
*```
*/
declare function L(...Arguments: Array<any>): Layout;
